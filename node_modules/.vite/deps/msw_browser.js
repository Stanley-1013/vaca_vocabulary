...
var _returnType, _a2, _b, _c, _d;
var TypedEvent = (_d = class extends MessageEvent {
  constructor(...args) {
    super(args[0], args[1]);
    /**
     ...
     */
    __privateAdd(this, _returnType, void 0);
...
}, _a2 = kDefaultPrevented2, _b = kPropagationStopped, _c = kImmediatePropagationStopped, _returnType = new WeakMap(), _d);
var kListenerOptions = Symbol("kListenerOptions");
var _listeners, _addListener, addListener_fn, _proxyEvent, proxyEvent_fn, _callListener, callListener_fn, _a3;
var Emitter2 = (_a3 = class {
  constructor() {
    __privateAdd(this, _addListener);
    __privateAdd(this, _proxyEvent);
    __privateAdd(this, _callListener);
  ...
  on(type, listener, options) {
    return __privateMethod(this, _addListener, addListener_fn).call(this, type, listener, options);
  }
  /**
  ...
  earlyOn(type, listener, options) {
    return __privateMethod(this, _addListener, addListener_fn).call(this, type, listener, options, "prepend");
  }
  /**
  ...
  emit(event) {
    ...
    const proxiedEvent = __privateMethod(this, _proxyEvent, proxyEvent_fn).call(this, event);
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      __privateMethod(this, _callListener, callListener_fn).call(this, proxiedEvent.event, listener);
    }
    proxiedEvent.revoke();
    return true;
  }
  ...
  async emitAsPromise(event) {
    ...
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      pendingListeners.push(
        ...
        await Promise.resolve(__privateMethod(this, _callListener, callListener_fn).call(this, proxiedEvent.event, listener))
      );
    }
    proxiedEvent.revoke();
  ...
  *emitAsGenerator(event) {
    ...
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      yield __privateMethod(this, _callListener, callListener_fn).call(this, proxiedEvent.event, listener);
    }
    proxiedEvent.revoke();
  }
  /**
...
}, _listeners = new WeakMap(), _addListener = new WeakSet(), addListener_fn = function(type, listener, options, insertMode = "append") {
  var _a5;
  ...
  return this;
}, _proxyEvent = new WeakSet(), proxyEvent_fn = function(event) {
...
}, _callListener = new WeakSet(), callListener_fn = function(event, listener) {
  var _a5;
...
var WorkerEvent = (_a4 = class extends TypedEvent {
  constructor(workerEvent) {
    ...
    __privateAdd(this, _workerEvent, void 0);
